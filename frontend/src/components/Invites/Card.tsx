...
export default function InvitesCard({ name, email }: { name: string; email: string; }) {
    return (
        <>
            <div className="flex items-center p-3 w-72 h-28 bg-white rounded-md shadow-lg">
                ...
                <section className="block border-l border-gray-300 m-3">
                    ...
                    <div className="flex gap-3 pt-2 pl-3">
                        <FaCheckCircle className='w-4 hover:scale-125 duration-200 hover:cursor-pointer stroke-2 text-gray-100 hover:text-green-500' />
                        <FaBan className='w-4 hover:scale-125 duration-200 hover:cursor-pointer border-0 stroke-2 text-gray-100 hover:text-red-500' />
                    </div>
                </section>
            </div>
        </>
