...
export default function AdminHeader({ isOpen, setIsOpen }: { isOpen: boolean; setIsOpen: React.Dispatch<React.SetStateAction<boolean>> }) {
                    ...
                    <div id="collapseMenu"
                        ...
                        <ul
                            ...
                            <li className='max-lg:border-b border-gray-300 max-lg:py-3 px-3'>
                                <a href='/admin/home'
                                    className='hover:text-[#007bff] text-[#007bff] block font-semibold text-[15px]'>View User</a>
                            </li>
                            <li className='max-lg:border-b border-gray-300 max-lg:py-3 px-3'>
                                <a href='/admin/files'
                                    className='hover:text-[#007bff] text-[#007bff] block font-semibold text-[15px]'>View Files</a>
                            </li>
